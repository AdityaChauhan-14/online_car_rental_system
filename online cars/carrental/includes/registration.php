...
$sql="INSERT INTO  tblusers(FullName,EmailId,ContactNo,Aadhar_no,DL_no,Password) VALUES(:fname,:email,:mobile,:aadhar,:dlno,:password)";
                    ...
                    <div class="signup_wrap">
                        <div class="col-md-12 col-sm-6">
                            <form method="post" name="signup" onSubmit="return valid();">
                                ...
                                <div class="form-group">
                                    <input type="number" class="form-control" name="aadhar" placeholder="Aadhar number"
                                        maxlength="20" required="required">
                                </div>
                                <div class="form-group">
                                    <input type="number" class="form-control" name="dlno" placeholder="DL number"
                                        maxlength="20" required="required">
                                </div>
